...
struct DishCameraScreen: View {
    ...
    var body: some View {
        if denied {
            CaptureProblemView(
                message: "MacroLog needs camera access to photograph your dish. Enable it in Settings.",
...
final class DishCameraViewController: UIViewController, AVCapturePhotoCaptureDelegate {
    ...
    private let queue = DispatchQueue(label: "com.alexnovak.macrolog.dishcamera")
